  ...
  >
    ...
    <div className="relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto mb-8 md:mb-12">
        ...
        >
          <a
            ...
            className="hover:text-cyan-300 transition-all duration-300 break-all hover:drop-shadow-[0_0_8px_rgba(41,146,190,0.5)]"
          >
        ...
        >
          <a
            ...
            className="hover:text-blue-300 transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(23,51,87,0.5)]"
          >
            0306-1610701
          </a>
        </ContactItem>
        ...
        <ContactItem 
          ...
          glowColor="purple"
        >
          <span className="hover:text-purple-300 transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(35,87,128,0.5)]">
            Lahore, Pakistan
          </span>
        </ContactItem>
        ...
        <ContactItem 
          ...
          glowColor="pink"
        >
          <span className="hover:text-pink-300 transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.5)]">
            Coming Soon
          </span>
        </ContactItem>
      </div>
      ...
      <div className="text-center relative">
        ...
        <a
          href="https://wa.me/923061610701?text=Hello%20MA%20BYTES!%0A%0A%F0%9F%9A%80%20Building%20Websites%20That%20Grow%20Businesses%0A%0AI%20would%20like%20to%20know%20more%20about%20your%20services%20and%20discuss%20how%20we%20can%20work%20together."
          target="_blank"
