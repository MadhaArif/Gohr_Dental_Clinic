...
const WhyChooseUs = () => {
  const reasons = [
    ...
    {
      text: 'Fast loading & SEO optimized',
      icon: <Globe size={20} />,
      glow: 'purple'
    },
    {
    ...
    {
      text: 'Affordable pricing for small businesses',
      icon: <Users size={20} />,
      glow: 'pink'
    },
    {
    ...
    {
      text: 'Local expertise in Lahore',
      icon: <Zap size={20} />,
      glow: 'cyan'
    },
    {
    ...
    <section id="why-us" className="my-20 sm:my-32 scroll-mt-20 px-4 relative">
      ...
      <div className="text-center mb-12 sm:mb-16 relative z-10">
        ...
        <p className="text-xl text-cyan-200 max-w-2xl mx-auto">
          Building websites that help local businesses grow and reach more customers online
        </p>
      </div>
      ...
      <div className="text-center mt-12 sm:mt-16 relative z-10">
        <div className="inline-flex items-center gap-4 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-6 max-w-md mx-auto">
          ...
          <div className="text-left">
            <p className="text-cyan-300 font-semibold text-lg">Ready to grow your business online?</p>
            <p className="text-cyan-200 text-sm">Let's build your website today</p>
          </div>
